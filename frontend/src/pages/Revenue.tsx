  ...
  return (
    <div className='max-w-7xl mx-auto space-y-8 animate-fade-in-up'>
      ...
      <Card padding="lg" className="space-y-6 border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 shadow-sm relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-5 items-end bg-slate-50/50 dark:bg-slate-800/30 p-5 rounded-2xl border border-slate-100 dark:border-slate-700/50 relative z-10">
          <Input 
             type="date"
             label="Start Date"
          ...
          <div className="w-full">
            ...
            <select 
              className="w-full px-4 py-2.5 border border-slate-200 dark:border-slate-700 rounded-xl shadow-sm text-sm bg-white dark:bg-slate-800 text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-400 transition-all h-11 cursor-pointer font-medium"
              value={gender}
