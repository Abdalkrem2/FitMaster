...
public class WorkoutPlanMapper {
    ...
    public WorkoutPlanResponse toResponse(WorkoutPlan plan) {
        return WorkoutPlanResponse.builder()
                ...
                .completedDaysCount(plan.getCompletedDaysCount())
                .totalDaysInPlan(plan.getTotalDaysInPlan())
                .isWeekEnded(plan.getIsWeekEnded())
                .dailyStreak(plan.getMember().getDailyStreak())
                .streakLastUpdated(plan.getMember().getStreakLastUpdated())
