...
public class PackageController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<PackageDTOs.PackageDTO> updatePackage(@PathVariable Long id, @RequestBody PackageDTOs.UpdatePackageRequest req) {
    ...
    public ResponseEntity<PackageDTOs.PackageDTO> updatePackageStatus(@PathVariable Long id, @RequestBody PackageDTOs.UpdatePackageStatus status) {
